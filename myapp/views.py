...
def help_page(request):
    return render(request, 'help.html')  # Replace with the path to your help page template

# View for the FAQ Page
def FAQs_page(request):
    return render(request, 'FAQs.html')  # Replace with the path to your FAQ page template
